    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: "#030712" }}>
      ...
      >
        <div className="text-center mb-8">
          ...
          <p style={{ color: "#94a3b8" }}>Join the AQI Intelligence community</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label htmlFor="confirmPassword" className="block text-sm font-medium mb-2" style={{ color: "#94a3b8" }}>Confirm Password</label>
            <input
